...
import io.apptik.comm.jus.http.UrlComponentEncodingTester.Component;
import io.apptik.comm.jus.http.UrlComponentEncodingTester.Encoding;
...
public final class HttpUrlTest {
  ...
  @Test public void pathCharacters() throws Exception {
    UrlComponentEncodingTester test = new UrlComponentEncodingTester()
            .override(Encoding.PERCENT, '^', '{', '}', '|')
            .override(Encoding.SKIP, '\\', '?', '#')
            .skipForUri('%', '[', ']')
            .test(Component.PATH);
