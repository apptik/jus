...
public abstract class ConnectivityManager {
    ...
    List<ConnectivityListener> connectivityListeners = new ArrayList<>();

    public abstract NetworkInfo getActiveNetwork();

    public <T extends ConnectivityManager> T addListener(ConnectivityListener listener) {
        connectivityListeners.add(listener);
        return (T) this;
    }

    public <T extends ConnectivityManager> T removeListener(ConnectivityListener listener) {
     ...
     * <p>Use {@link ConnectivityManager#getActiveNetwork()} to get an instance that represents
